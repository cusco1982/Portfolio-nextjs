  ...
  return (
    <div>
      ...
      <div style={{backgroundColor:""}}>
        ...
        <Row style={{ padding: "0", padding: "30px", backgroundColor: "white", justifyContent: "center", fontWeight: "500" }}>
        ...
        <Row style={{ backgroundColor: "white", justifyContent: "", textAlign: "center", fontSize: "20px", padding: "0" }}>
          <Col>FOLLOW US ON INSTAGRAM @INSTAGRAM.COM/WJBESTINSULATION</Col>
        </Row>



        <Row style={{ padding: "0", paddingBottom: "40px", backgroundColor:"white" }}>
